...
<body>
    ...
    <h1> Tots els usuaris de la base de dades:</h1>


    <div class="col-12">
        <form class="d-flex" style="margin-top:30px; margin-bottom:30px;">
            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="border: 2px solid;">
            <!-- COMPONENT BUTTON -->
